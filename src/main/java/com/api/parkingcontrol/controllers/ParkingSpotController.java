...
public class ParkingSpotController {
    ...
    public ResponseEntity<Object> saveParkingSpot(@RequestBody @Valid ParkingSpotDto dto) {
        ...
        if (this.parkingSpotService.existsByParkingSpotNumber(dto.getParkingSpotNumber())) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(parkingSpotService.save(model));
    }
    ...
    public ResponseEntity<Object> updateParkingSpot(@PathVariable(value = "id") UUID id,
        ...
        BeanUtils.copyProperties(dto, parkingSpotModelOptional);
